...
export default function Chatbot() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      {isOpen && (
        <div className="flex flex-col w-[340px] sm:w-[380px] h-[500px] bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden mb-4 animate-fadeIn backdrop-blur-md">
          {/* Header */}
      ...
      {/* 2. Floating Circular Toggle Button */}
      <button
        onClick={handleToggle}
        type="button"
